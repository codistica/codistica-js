...
function ViewportMonitorSection() {
    ...
    return (
        <Section category={category} title={title} description={description}>
            ...
            <h3>
                {'windowRatio: '}
                {Math.round(viewportState.windowRatio * 100) / 100}
            </h3>
            <h3>
                {'zoom: '}
                {viewportState.zoom}
            ...
            <h3>
                {'scrollbar: '}
                {viewportState.scrollbar}
            </h3>
            <h3>
                {'deltaVh: '}
                {viewportState.deltaVh}
            </h3>
            <h3>
                {'deltaVw: '}
                {viewportState.deltaVw}
            </h3>
            <h3>
                {'ratioVh: '}
                {Math.round(viewportState.ratioVh * 100) / 100}
            </h3>
            <h3>
                {'ratioVw: '}
                {Math.round(viewportState.ratioVw * 100) / 100}
            </h3>
            <h3>
                {'minimalUI: '}
                {`${viewportState.minimalUI || 'false'}`}
            </h3>
        </Section>
    );
}
