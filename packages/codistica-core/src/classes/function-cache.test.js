...
describe('FunctionCache', () => {
    ...
    describe('has()', () => {
        ...
        it('Should state that a new entry exists.', () => {
            assert.isTrue(functionCache.has(nonModifiedArg, nonModifiedValue));
            assert.isTrue(functionCache.has(1, 2, 3, 'value'));
        });
        it('Should state that a modified entry exists.', () => {
            assert.isFalse(functionCache.has(modifiedValue, preModifiedValue));
    ...
    describe('get()', () => {
        ...
        it('Should return the value of a modified entry.', () => {
            assert.strictEqual(functionCache.get(modifiableArg), modifiedValue);
        });
    ...
    describe('delete()', () => {
        ...
        it('Should only delete the value of a new entry.', () => {
            ...
            assert.isFalse(functionCache.has(nonModifiedArg, nonModifiedValue));
