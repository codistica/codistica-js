...
import {getValidFullYear} from './get-valid-full-year.js';

/** @see module:core/modules/date-utils/get-valid-full-year */
...
describe('getValidFullYear()', () => {
    it('Should return an integer with the closer full year matching of a two digit input.', () => {
        ...
        assert.strictEqual(getValidFullYear(currentYear - 2000), currentYear);
        assert.strictEqual(
